...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        noticeRepository.save(new Notice("1번째 제목", "1번째 내용", "홍길동", 0, 0, "NONE", "NONE", dateUtil.currentDateInTimestamp(), dateUtil.currentDateInTimestamp(), null));
        noticeRepository.save(new Notice("2번째 제목", "2번째 내용", "임꺽정", 0, 0, "NONE", "NONE", dateUtil.currentDateInTimestamp(), dateUtil.currentDateInTimestamp(), null));
